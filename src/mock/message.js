const privateMessage = [
    ...
    {chatWithId:11, sender:'赵如海',notReadNum: 1, latestMessage:'咱们谈谈需求吧！',latestTime: '2020-03-09'},
    {chatWithId:12, sender:'李思源',notReadNum: 0, latestMessage:'项目启动已完成',latestTime: '2020-03-09'},
    {chatWithId:13, sender:'刘芳',notReadNum: 0, latestMessage:'挺好的，我看好你',latestTime: '2020-03-09'},
    {chatWithId:21, sender:'赵如海',notReadNum: 1, latestMessage:'咱们谈谈需求吧！',latestTime: '2020-03-09'},
    {chatWithId:22, sender:'李思源',notReadNum: 0, latestMessage:'项目启动已完成',latestTime: '2020-03-09'},
    {chatWithId:23, sender:'刘芳',notReadNum: 0, latestMessage:'挺好的，我看好你',latestTime: '2020-03-09'},
    {chatWithId:31, sender:'赵如海',notReadNum: 1, latestMessage:'咱们谈谈需求吧！',latestTime: '2020-03-09'},
    {chatWithId:32, sender:'李思源',notReadNum: 0, latestMessage:'项目启动已完成',latestTime: '2020-03-09'},
    {chatWithId:33, sender:'刘芳',notReadNum: 0, latestMessage:'挺好的，我看好你',latestTime: '2020-03-09'},
];

const teamMessage = [
    {teamId:4, Team: "你知科研团队",notReadNum: 10, latestSender: "孙香", latestMessage: "收到" ,latestTime: '2020-03-09'},
    {teamId:5, Team: "暨南软件影票售卖系统",notReadNum: 10, latestSender: "赵浩", latestMessage: "老师新年快乐~" ,latestTime: '2020-02-17'},
    {teamId:6, Team: "刘培念课题组",notReadNum: 1, latestSender: "吴名", latestMessage: "大家查看下任务大家查看下任务大家查看下任务大家查看下任务" ,latestTime: '2020-03-09'},
];
