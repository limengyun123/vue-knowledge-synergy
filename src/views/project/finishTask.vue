        ...
        <div class="finish-task-body">
            <el-form :model="task" ref="task" status-icon label-width="100px" >
                <el-form-item label="指派人" prop="assignerName">
                    <el-input v-model="task.assigner" disabled></el-input>
                </el-form-item>
                <el-form-item label="开始时间" prop="startTime">
                    <el-date-picker v-model="task.startTime" type="datetime"  disabled> </el-date-picker>
                </el-form-item>
                <el-form-item label="截止时间" prop="endTime">
                    <el-date-picker v-model="task.endTime" type="datetime" disabled> </el-date-picker>
                </el-form-item>
                <el-form-item label="描述" prop="content">
                    <el-input type="textarea" v-model="task.content" disabled></el-input>
                </el-form-item>
...
export default {
    ...
    created(){
        this.task = this.$store.state.taskInfo;
    },
    methods: {
        chooseFileClick(e){
            e.preventDefault();
